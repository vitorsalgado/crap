...
private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
    ...
    vf = Double.parseDouble(editValorFinanciado.getText());
    i = Double.parseDouble(editTxJuros.getText());
    ...
    for(int cont = 0; cont < n; cont++){
        ...
        tbm.addRow(new Object[]{
           ...
           df.format(saldo * i),
           df.format(amort),
           df.format(amort + (saldo * i)),
           df.format(saldo - amort)
        });
